...
import com.birutekno.aiwa.InputActivity;
...
//        editTextNamaAyah = (EditText) view.findViewById(R.id.edit_text_nama_ayah);
        ...
        jumlah = bundle.getInt("jumlah");
        cjumlah = bundle.getInt("cjumlah");
        alamat = bundle.getString("alamat");
        step.setText(String.valueOf(cjumlah) + " / "+ String.valueOf(jumlah));
    }
