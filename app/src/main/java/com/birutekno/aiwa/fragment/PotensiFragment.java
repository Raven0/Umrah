...
public class PotensiFragment extends BaseFragment{
    ...
    private void loadJSON(String periode){
        ...
        Call<PotkomResponse> call = WebApi.getAPIService().getDataPotensi(String.valueOf(idAgen), periode);
        ...
        call.enqueue(new Callback<DashboardModel>() {
            ...
            public void onResponse(Call<DashboardModel> call, Response<DashboardModel> response) {
                try{
                    ...
                    Log.d("MONEYMONEYMONEY", "onResponse: " + response.body().getResponse().getTotal());
                    Log.d("MONEYMONEYMONEY", "onResponse: " + tahunSelected);
