package com.birutekno.umrah.ui;
...
public abstract class BaseActivity extends RxAppCompatActivity {
    ...
    protected void setupToolbar(final Toolbar toolbar, boolean needHomeButton) {
        setupToolbar(toolbar, needHomeButton, null);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    protected void setupToolbar(final Toolbar toolbar, boolean needHomeButton, final View.OnClickListener onClickListener) {
