...
//                }
    ...
    private Call<PotkomResponse> callTopRatedMoviesApi(String tahun) {
        ...
        return WebApi.getAPIService().getDataKomisiKoord(String.valueOf(id), tahun, currentPage);
    }
    ...
    private Call<PotkomResponse> firstCallTopRatedMoviesApi(String tahun) {
        ...
        currentPage = 1;
        return WebApi.getAPIService().getDataKomisiKoord(String.valueOf(id), tahun, 1);
    }
        ...
        call.enqueue(new Callback<DashboardModel>() {
            ...
            public void onResponse(Call<DashboardModel> call, Response<DashboardModel> response) {
                try{
                    ...
                    judul.setText("Komisi dari Agen Anda Saat ini");
