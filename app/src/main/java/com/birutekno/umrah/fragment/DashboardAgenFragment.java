...
public class DashboardAgenFragment extends BaseFragment implements DatePickerDialog.OnDateSetListener{
    ...
    protected void onViewReady(@Nullable Bundle savedInstanceState ) {
        ...
        periode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = DatePickerDialog.newInstance((DatePickerDialog.OnDateSetListener) DashboardAgenFragment.this,
