...
//                }
    ...
    private Call<PotkomResponse> callTopRatedMoviesApi(String tahun) {
        ...
        return WebApi.getAPIService().getDataPotensiKoord(String.valueOf(id), tahun, currentPage);
    }
    ...
    private void loadDataPotensi(final String id){
        Call<DashboardModel> call = WebApi.getAPIService().getUangKoordPotensi(id);
