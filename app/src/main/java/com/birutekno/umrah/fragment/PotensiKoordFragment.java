...
public class PotensiKoordFragment extends BaseFragment{
    ...
    public static PotensiKoordFragment newInstance() {
        PotensiKoordFragment fragment = new PotensiKoordFragment();
        return fragment;
    }
    ...
    protected void onViewReady(@Nullable Bundle savedInstanceState) {
        ...
        periode.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                loadJSON(item);
                loadDataPotensi(String.valueOf(idAgen),item);
            }

            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                loadJSON(token);
                loadDataPotensi(String.valueOf(idAgen),token);
            }
        });
    ...
    private void loadJSON(String periode){
        ...
        Call<PotkomResponse> call = WebApi.getAPIService().getDataPotensiKoord(String.valueOf(idAgen), periode);
