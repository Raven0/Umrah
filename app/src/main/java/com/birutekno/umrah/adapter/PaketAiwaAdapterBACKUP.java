...
public class PaketAiwaAdapterBACKUP extends RecyclerView.Adapter<PaketAiwaAdapterBACKUP.ViewHolder> {
    ...
    public PaketAiwaAdapterBACKUP(ArrayList<Jadwal> jadwal, ArrayList<Paket> paket, Context context) {
        this.jadwal = jadwal;
        this.paket = paket;
    ...
    @Override
    public PaketAiwaAdapterBACKUP.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_paketb, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(PaketAiwaAdapterBACKUP.ViewHolder viewHolder, int i) {
...
//                    shareIntent.putExtra(Intent.EXTRA_TEXT, whatsAppMessage);
                    shareIntent.putExtra(Intent.EXTRA_TEXT, linkItinerary);
